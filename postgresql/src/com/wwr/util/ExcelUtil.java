...
public class ExcelUtil {
     ...
     * 
     */
    public boolean write(List<List<String>> rowData,OutputStream os) throws IOException {
        return write(0, rowData, 0,os);
    }
     ...
     * @throws IOException
     */
    public boolean write(List<List<String>> rowData, String sheetName, boolean isNewSheet,OutputStream os) throws IOException {
        Sheet sheet = null;
        if (isNewSheet) {
        ...
        return write(sheetIx, rowData, 2,os);
    }
     ...
     * @throws IOException
     */
    public boolean write(int sheetIx, List<List<String>> rowData, boolean isAppend,OutputStream os) throws IOException {
        if (isAppend) {
            return write(sheetIx, rowData, getRowCount(sheetIx),os);
        } else {// 清空再添加
            clearSheet(sheetIx);
            return write(sheetIx, rowData, 0,os);
        }
    }
     ...
     * @throws IOException
     */
    public boolean write(int sheetIx, List<List<String>> rowData, int startRow,OutputStream os) throws IOException {
        Sheet sheet = workbook.getSheetAt(sheetIx);
